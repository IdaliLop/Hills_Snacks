...
function mostrarFormularioEmpleado() {
    document.getElementById("formulario-empleado-modal").style.display = "flex";
}

// Ocultar el modal cuando el usuario hace clic en "Cancelar" o en la "X"
function ocultarFormularioEmpleado() {
    document.getElementById("formulario-empleado-modal").style.display = "none";
}
